...
const handleRefreshToken = asyncHandler(async (req, res) => {
  ...
  if(!user) throw new Error(" No Refresh token present in ddb or not matched");
...
// const updatePassword = asyncHandler(async (req, res) => {
//   const { _id } = req.user;
//   const newPassword = req.body.password; // Assuming your request body has a 'password' field
//   validateMongoDbId(_id);
...
//       res.json(updatedUser);
//     } else {
//       res.status(400).json({ error: 'New password not provided.' });
//     }
//   } catch (error) {
//     console.error(error);
